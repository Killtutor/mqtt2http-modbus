...
<c:choose>
  ...
  <c:otherwise>
    ...
    <script type="text/javascript">
      ...
      byId("flipbook${componentId}").src = "<%= ImageValueServlet.servletPath %>"+ flipbookArray${componentId}[flipbookArray${componentId}.length-1] +"?w=400&h=300";
      alert(byId("flipbook${componentId}").src);
    </script>
  </c:otherwise>
</c:choose>