...
<jsp:attribute name="subtitle">
  <fmt:message key="events.pointDetails"/>
</jsp:attribute>
<jsp:body>
  <script type="text/javascript">
    ...
    function getHistoryTableData() {
        ...
        if (isNaN(limit))
            ...
            startImageFader(byId("historyLimitImg"));
            DataPointDetailsDwr.getHistoryTableData(limit, function(response) {
                ...
                byId("historyTableAsof").innerHTML = response.data.asof;
                stopImageFader(byId("historyLimitImg"));
            });
        }
    }
    ...
    function getImageChart() {
        ...
        DataPointDetailsDwr.getImageChartData($get("fromYear"), $get("fromMonth"), $get("fromDay"), $get("fromHour"),
            ...
            byId("imageChartDiv").innerHTML = response.data.chart;
            byId("imageChartAsof").innerHTML = response.data.asof;
    ...
    function getStatsChart() {
        ...
        if (isNaN(period))
            ...
            startImageFader(byId("statsChartImg"));
            DataPointDetailsDwr.getStatsChartData(periodType, period, true, function(response) {
                byId("statsChartData").innerHTML = response.data.stats;
                byId("statsAsof").innerHTML = response.data.asof;
                stopImageFader(byId("statsChartImg"));
            });
        }
    }
    ...
    function getFlipbookChart() {
        ...
        if (isNaN(limit))
            ...
            startImageFader(byId("flipbookChartImg"));
            DataPointDetailsDwr.getFlipbookData(limit, function(response) {
                ...
                byId("flipbookAsof").innerHTML = response.data.asof;
                stopImageFader(byId("flipbookChartImg"));
            });
        }
    }

    function swapFlipbookImage(uri) {
        byId("flipbookImage").src = uri;
    }
  </script>
