...
<script type="text/javascript">
  function changeLoggingType() {
      ...
      var tolerance = byId("tolerance");
      var purgePeriod = byId("purgePeriod");
      var purgeType = byId("purgeType");

      if (byId("toleranceSection") && loggingType == <%= DataPointVO.LoggingTypes.ON_CHANGE %>)
  ...
  function changeDiscard() {
      ...
      if (discard) {
          byId("discardLowLimit").disabled = false;
          byId("discardHighLimit").disabled = false;
      }
      else {
          byId("discardLowLimit").disabled = true;
          byId("discardHighLimit").disabled = true;
      }
  }
  ...
  dojo.addOnLoad(function() {
      if (dataTypeId == <%= DataTypes.NUMERIC %>) {
          ...
          byId("intervalLoggingType").disabled = true;
