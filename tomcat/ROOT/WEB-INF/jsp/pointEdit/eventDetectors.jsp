...
<div class="borderDiv">
  ...
  <table style="display:none;">
    <tbody id="detectorType<%= PointEventDetectorVO.TYPE_ANALOG_HIGH_LIMIT %>">
      ...
      <tr>
        <td class="formLabel"><fmt:message key="pointEdit.detectors.eventDescription"/></td>
        <td class="formField"><input id="eventDetector_TEMPLATE_EventDescription" type="text" class="formLong"/></td>
      </tr>
      <tr>
        <td class="formLabelRequired"><fmt:message key="pointEdit.detectors.editPermission"/></td>
        <td class="formField">
          <sst:select id="eventDetector_TEMPLATE_EditPermission">
            <sst:option value="<%= Integer.toString(PointEventDetectorVO.EDIT_PERMISSION_SUPER_ADMIN) %>"><fmt:message key="pointEdit.detectors.editPermission.superAdmin"/></sst:option>
            <sst:option value="<%= Integer.toString(PointEventDetectorVO.EDIT_PERMISSION_ADMIN) %>"><fmt:message key="pointEdit.detectors.editPermission.admin"/></sst:option>
            <sst:option value="<%= Integer.toString(PointEventDetectorVO.EDIT_PERMISSION_DATAPOINT_SET) %>"><fmt:message key="pointEdit.detectors.editPermission.dataPointEdit"/></sst:option>
            <sst:option value="<%= Integer.toString(PointEventDetectorVO.EDIT_PERMISSION_DATAPOINT_READ) %>"><fmt:message key="pointEdit.detectors.editPermission.dataPointRead"/></sst:option>
          </sst:select>
        </td>
      </tr>
      <tr>
...
<script type="text/javascript">
  ...
  function PointEventDetectorEditor() {
      ...
      this.addEventDetectorCB = function(detector) {
          ...
          var content = byId("detectorType"+ detector.detectorType).cloneNode(true);
          ...
          byId("eventDetectorTable").appendChild(content);
          ...
          $set("eventDetector"+ detector.id +"EventDescription", detector.eventDescription);
          $set("eventDetector"+ detector.id +"EditPermission", detector.editPermission);
      ...
      this.updateAlarmLevelImage = function(alarmLevel, pedId) {
          setAlarmLevelImg(alarmLevel, byId("eventDetector"+ pedId +"AlarmLevelImg"));
      }
      ...
      this.deleteDetector = function(pedId) {
          ...
          var content = byId("eventDetector"+ pedId);
          byId("eventDetectorTable").removeChild(content);
      }
      ...
      this.save = function(callback) {
          var edTableNodes = byId("eventDetectorTable").childNodes;
          saveCBCount = 0;
          ...
          for (var i=0; i<edTableNodes.length; i++) {
              ...
              var eventDescription = $get("eventDetector"+ pedId +"EventDescription");
              var editPermission = $get("eventDetector"+ pedId +"EditPermission");
              ...
              if (pedType == <%= PointEventDetectorVO.TYPE_ANALOG_HIGH_LIMIT %>) {
                  ...
                  if (isNaN(limit))
                      ...
                      DataPointEditDwr.updateHighLimitDetector(pedId, xid, alias, limit, duration, durationType,
                              alarmLevel, editPermission, eventDescription, saveCB);
                  }
              }
                  ...
                  saveCBCount++;
                  DataPointEditDwr.updatePointChangeDetector(pedId, xid, alias, alarmLevel, editPermission, eventDescription, saveCB);
              }
                  ...
                  if (isNaN(duration))
                      ...
                      DataPointEditDwr.updateNoChangeDetector(pedId, xid, alias, duration, durationType, alarmLevel,
                            editPermission, eventDescription, saveCB);
                  }
              }
                  ...
                  if (isNaN(limit))
                      ...
                      DataPointEditDwr.updatePositiveCusumDetector(pedId, xid, alias, limit, weight, duration,
                              durationType, alarmLevel, editPermission, eventDescription, saveCB);
                  }
              }
              ...
              if (errorMessage != null) {
                  ...
                  byId("eventDetector"+ pedId +"ErrorMessage").innerHTML = errorMessage;
              }
              else
                  byId("eventDetector"+ pedId +"ErrorMessage").innerHTML = "";
          }
          dwr.engine.endBatch();
