...
<jsp:body>
  ...
  <script type="text/javascript">
    ...
    require(["dijit/Calendar", "dojo/domReady!"], function(Calendar){
            datePicker = new Calendar({
                ...
                onChange: jumpToDateClicked
                });
            datePicker.placeAt(byId("datePickerDiv"));
        }
    );
    ...
    function jumpToDateClicked() {
        if (isShowing("datePickerDiv")) {
            hide("datePickerDiv");
            doSearch(0, datePicker.get("value"));
        }
    }

    function newSearch() {
        datePicker.set("value", new Date());
        doSearch(0);
    }
    ...
    function exportEvents() {
        startImageFader(byId("exportEventsImg"));
        EventsDwr.exportEvents($get("eventId"), $get("eventSourceType"), $get("eventStatus"), $get("alarmLevel"),
            ...
            stopImageFader(byId("exportEventsImg"));
  ...
  <div id="datePickerDiv" style="position:absolute; top:0px; left:0px; display:none;" onmouseover="cancelDatePickerExpiry()" onmouseout="expireDatePicker()"></div>
</jsp:body>
</tag:page>