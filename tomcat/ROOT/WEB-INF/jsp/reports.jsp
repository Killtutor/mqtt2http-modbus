...
<tag:page dwr="ReportsDwr" js="Recipients" onload="init">
<jsp:attribute name="subtitle">
  <fmt:message key="header.reports"/>
</jsp:attribute>
<jsp:body>
  <script type="text/javascript">
    ...
    function writeReportPointsArray() {
        ...
        if (reportPointsArray.length == 0) {
            show(byId("reportPointsTableEmpty"));
            hide(byId("reportPointsTableHeaders"));
        }
        else {
            hide(byId("reportPointsTableEmpty"));
            show(byId("reportPointsTableHeaders"));
    ...
    function deleteReportInstance(instanceId) {
        var img = byId("ri"+ instanceId +"DeleteImg");
    ...
    function deleteReport() {
        ...
        stopImageFader("r"+ selectedReport.id +"Img");
        byId("reportsTable").removeChild(byId("r"+ selectedReport.id));
        hide("reportDetails");
        selectedReport = null;
    }
