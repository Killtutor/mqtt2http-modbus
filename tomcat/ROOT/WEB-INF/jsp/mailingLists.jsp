...
<jsp:attribute name="subtitle">
  <fmt:message key="header.mailingLists"/>
</jsp:attribute>
<jsp:body>
  <script>
    var users = new Array();
    ...
    function appendUserEntry(userEntry) {
        ...
        setUserImg(userEntry.user.admin, userEntry.user.disabled, byId("mle"+ userEntry.referenceId +"Img"));
        byId("mle"+ userEntry.referenceId +"Username").innerHTML = userEntry.user.username;
    }

    function deleteUserEntry(entryId) {
        // Delete the visual entry.
        byId("mailingListEntriesTable").removeChild(byId("mleUser"+ entryId));
    ...
    function appendAddressEntry(addressEntry) {
        ...
        byId("mle"+ addressEntry.referenceId +"Address").innerHTML = addressEntry.referenceAddress;
    }

    function deleteAddressEntry(entryId) {
        // Delete the visual entry.
        byId("mailingListEntriesTable").removeChild(byId("mleAddress"+ entryId));
    ...
    function deleteMailingList() {
        MailingListsDwr.deleteMailingList(editingMailingList.id, function() {
            stopImageFader(byId("ml"+ editingMailingList.id +"Img"));
            byId("mailingListsTable").removeChild(byId("ml"+ editingMailingList.id));
            hide(byId("mailingListDetails"));
