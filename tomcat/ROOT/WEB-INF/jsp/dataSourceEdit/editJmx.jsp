...
<script type="text/javascript">
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveJmxPointLocator(currentPoint.id, $get("xid"), $get("name"), $get("deviceName"), locator, savePointCB);
  }
      ...
      DataSourceEditDwr.getJmxObjectNames(localServer, $get("remoteServerAddr"), function(response) {
    	  ...
    	  if (response.hasMessages)
              ...
              var parentNode = dojo.widget.createWidget("TreeNode", {
            	  title: "<b>"+ (localServer ? "<fmt:message key="dsEdit.jmx.dsconn.local"/>" : byId("remoteServerAddr")) +"</b>",
            	  isFolder: true
              });
