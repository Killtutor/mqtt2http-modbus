...
<script type="text/javascript">
  ...
  function initImpl() {
      createContextualMessageNode(byId("incrementMultistateTable"), "incrementMultistateChange.values");
      createContextualMessageNode(byId("randomMultistateTable"), "randomMultistateChange.values");
  }
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveVirtualPointLocator(currentPoint.id, $get("xid"), $get("name"), $get("deviceName"), locator, savePointCB);
  }
  ...
  function changeDataTypeCB(changeTypes) {
      var changeTypeDD = byId("changeTypeId");
  ...
  function refreshValueList(prefix, arr) {
      ...
      var startDD = byId(prefix +"Change.startValue");
