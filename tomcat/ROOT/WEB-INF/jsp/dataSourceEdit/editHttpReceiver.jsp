...
<script type="text/javascript">
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveHttpReceiverPointLocator(currentPoint.id, $get("xid"), $get("name"), $get("deviceName"), locator, savePointCB);
  }

  function changeDataTypeId() {
      var dataTypeId = $get("dataTypeId");
      if (dataTypeId == <%= DataTypes.BINARY %>)
          setDisabled(byId("binary0Value"), false);
      else
          setDisabled(byId("binary0Value"), true);
  }
</script>
