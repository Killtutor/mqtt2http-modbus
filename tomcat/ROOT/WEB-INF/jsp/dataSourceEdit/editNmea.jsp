...
<script type="text/javascript">
  ...
  function listenCancel() {
      DataSourceEditDwr.cancelTestingUtility(function() {
          listenButtons(false);
          byId("listenMessage").innerHTML = "<fmt:message key="common.cancelled"/>";
      });
  }
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveNmeaPointLocator(currentPoint.id, $get("xid"), $get("name"), $get("deviceName"), locator, savePointCB);
  }
