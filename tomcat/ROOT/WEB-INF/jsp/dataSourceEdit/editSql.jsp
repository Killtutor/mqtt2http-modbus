...
<script type="text/javascript">
  ...
  function sqlTestButton(testing) {
      setDisabled(byId("sqlTestBtn"), testing);
  }
  ...
  function writePointListImpl(points) {
      var rowBasedQuery = byId("rowBasedQuery");
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveSqlPointLocator(currentPoint.id, $get("xid"), $get("name"), $get("deviceName"), locator, savePointCB);
  }
