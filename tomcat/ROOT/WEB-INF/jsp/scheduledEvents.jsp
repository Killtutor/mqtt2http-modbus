...
<jsp:attribute name="subtitle">
  <fmt:message key="header.scheduledEvents"/>
</jsp:attribute>
<jsp:body>
  <script type="text/javascript">
    ...
    function showScheduledEvent(seId) {
        ...
        startImageFader(byId("se"+ seId +"Img"));

        if (seId == ${NEW_ID})
            hide(byId("deleteScheduledEventImg"));
        else
            show(byId("deleteScheduledEventImg"));
    }
        ...
        ScheduledEventsDwr.saveScheduledEvent(editingScheduledEvent.id, $get("xid"), $get("alias"), $get("alarmLevel"),
            ...
            if (response.hasMessages)
                ...
                if (editingScheduledEvent.id == ${NEW_ID}) {
                    ...
                    startImageFader(byId("se"+ editingScheduledEvent.id +"Img"));
    ...
    function updateScheduledEvent(se) {
        byId("se"+ se.id +"Name").innerHTML = se.description;
        setScheduledEventImg(se.disabled, byId("se"+ se.id +"Img"));
    }

    function deleteScheduledEvent() {
        ScheduledEventsDwr.deleteScheduledEvent(editingScheduledEvent.id, function() {
            stopImageFader(byId("se"+ editingScheduledEvent.id +"Img"));
            byId("scheduledEventsTable").removeChild(byId("se"+ editingScheduledEvent.id));
            hide(byId("scheduledEventDetails"));
    ...
    function refreshDateTimeFields() {
        ...
        display(byId("inactiveDateTimeRow"), rtn);
