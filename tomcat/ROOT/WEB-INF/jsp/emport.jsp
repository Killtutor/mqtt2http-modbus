  ...
  <script type="text/javascript">
    ...
    function doExport() {
        ...
        EmportDwr.createExportData($get("prettyIndent"), $get("graphicalViews"), $get("eventHandlers"),
                ...
                $get("pointLinks"), $get("users"), $get("pointHierarchy"), $get("mailingLists"), $get("phonesLists"),
                $get("publishers"), $get("watchLists"), $get("maintenanceEvents"), $get("textGateways"), function(data) {
            $set("emportData", data);
    ...
    function doImport() {
        ...
        EmportDwr.importData($get("emportData"), function(response) {
            if (response.data.importStarted)
                ...
                showDwrMessages(response.messages, byId("importMessages"));
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td>
          ...
          <input type="checkbox" id="phonesLists"/> <label for="phonesLists"><fmt:message key="header.phonesLists"/></label><br/>
          ...
          <input type="checkbox" id="textGateways"/> <label for="textGateways"><fmt:message key="textGatewayList.textGateways"/></label><br/>
        </td>
...
<!--          <input type="checkbox" id="dynamicImages"/> <label for="dynamicImages"><fmt:message key="header.dynamicImages"/></label><br/>-->
      ...
      <tr>
        ...
        <td><input type="text" id="prettyIndent" value="4" class="formVeryShort"/></td>
      </tr>
      <tr>
