...
alter table phonesLists add constraint phonesListsPk primary key (id);
...
alter table textGateways add constraint textGatewaysPk primary key (id);
...
alter table textMessages add constraint textMessagesPk primary key (id);
